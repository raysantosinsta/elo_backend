...
// Métricas (Mantive as métricas pois são úteis para monitoramento, 
// mas se quiser remover, basta apagar estas linhas e os usos delas)
...
export class KanbanColumnService {
  ...
  async delete(id: string, companyId: string) {
    ...
    await this.prisma.$transaction(async (tx) => {
      // 1. Mover tarefas se houver coluna de fallback
      if (fallbackColumn) {
